...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "StableCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* StableCoin features */
        {"stablecoin", "masternode", &masternode, true, true, false},
        {"stablecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"stablecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stablecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stablecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stablecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"stablecoin", "startmasternode", &startmasternode, true, true, false},
        {"stablecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stablecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stablecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stablecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stablecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stablecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stablecoin", "mnbudget", &mnbudget, true, true, false},
        {"stablecoin", "preparebudget", &preparebudget, true, true, false},
        {"stablecoin", "submitbudget", &submitbudget, true, true, false},
        {"stablecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stablecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stablecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stablecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stablecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stablecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stablecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stablecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"stablecoin", "mnsync", &mnsync, true, true, false},
        {"stablecoin", "spork", &spork, true, true, false},
        {"stablecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"stablecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use stablecoind, or the -server option to stablecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> stablecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58121/\n";
}

...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total stablecoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zSTABLsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSTABL denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSTABL denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSTABL denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSTABL denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSTABL denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSTABL denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSTABL denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSTABL denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSTABL denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in stablecoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in stablecoin/kb\n"
    ...
    Object zstablecoinObj;
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zstablecoinObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zstablecoinObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zSTABLsupply", zstablecoinObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given stablecoin address.\n"
            "\nArguments:\n"
            "1. \"stablecoinaddress\"     (string, required) The stablecoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"stablecoinaddress\", (string) The stablecoin address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are stablecoin addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) stablecoin address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"stablecoinaddress\"  (string, required) The stablecoin address to use for the signature.\n"

...
{
public:
    /// Is the inputs associated with this public key? (and there is 25000 STABL - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of stablecoin.

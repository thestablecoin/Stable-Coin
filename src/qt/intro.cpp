...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("StableCoin Core"),
     ...
     * override -datadir in the stablecoin.conf file in the default data directory
     * (to be consistent with stablecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

...
public:
    ...
    void setZStableCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSTABL_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSTABL_clicked();
    void on_pushButtonZStableCoinControl_clicked();

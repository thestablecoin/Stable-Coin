Contributing to StableCoin Core
============================

The StableCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the StableCoin Core project, and is not to be
confused with overall StableCoin Network Protocol consensus changes.

Whether a pull request is merged into StableCoin Core rests with the project merge
...
Patches that change StableCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the StableCoin consensus, it must have been
...
The project leader is the release manager for each StableCoin Core release.

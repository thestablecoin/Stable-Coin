...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/stablecoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/stablecoin-cli.cpp \
           src/stablecoin-tx.cpp \
           src/stablecoin.cpp \
           src/db.cpp \
           ...
           src/qt/stablecoin.cpp \
           src/qt/stablecoinstrings.cpp \
...
RESOURCES += src/qt/stablecoin.qrc src/qt/stablecoin_locale.qrc

TRANSLATIONS += src/qt/locale/stablecoin_bg.ts \
                src/qt/locale/stablecoin_de.ts \
                src/qt/locale/stablecoin_en.ts \
                src/qt/locale/stablecoin_es.ts \
                src/qt/locale/stablecoin_fi.ts \
                src/qt/locale/stablecoin_fr.ts \
                src/qt/locale/stablecoin_it.ts \
                src/qt/locale/stablecoin_ja.ts \
                src/qt/locale/stablecoin_pl.ts \
                src/qt/locale/stablecoin_pt.ts \
                src/qt/locale/stablecoin_ru.ts \
                src/qt/locale/stablecoin_sk.ts \
                src/qt/locale/stablecoin_sv.ts \
                src/qt/locale/stablecoin_vi.ts \
                src/qt/locale/stablecoin_zh_CN.ts \
                src/qt/locale/stablecoin_zh_TW.ts

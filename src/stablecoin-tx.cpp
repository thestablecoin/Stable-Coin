...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StableCoin Core stablecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stablecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stablecoin transaction") + "\n" +
                               "  stablecoin-tx [options] -create [commands]   " + _("Create hex-encoded stablecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stablecoin transaction

...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000007322b81a1827d9d00f7aadb639d26d6d08c3cbb68176e171ec2bd315b98"))
	(1, uint256("00000e7589a126606b03158679db2cd3dd4adc818fb9c74e35ef3eea89e25074"))
	(2, uint256("000006e2ca1b0cea731a2ec3923e51fc6667db4e2db459443714ec0899137d0b"))
	(3, uint256("00000f7bb8c7797f3e795c37712636d7ebe962aeb8426ead03d734f3100e54c7"))
	(4, uint256("00000490fc63428e2a73511007c40cad5f605fa6baaad8b8248e748f7c5da8b9"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 58120;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // StableCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60 * 60; // StableCoin: 1 day  
        nTargetSpacing = 1 * 60; // StableCoin: 1 Min
        nMaturity = 30;
         ...
         *   vMerkleTree: e0028e
         */
		const char* pszTimestamp = "StableCoin MainNet Launch"; 
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1549280605; 
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1535683; 

        hashGenesisBlock = genesis.GetHash();
		
        assert(hashGenesisBlock == uint256("000007322b81a1827d9d00f7aadb639d26d6d08c3cbb68176e171ec2bd315b98")); 
        assert(genesis.hashMerkleRoot == uint256("01b83b1dcab3f7c93937e44ca14fa8b16b368f3a7f21aaa4ba7118c059ef4cc5")); 

		//added new nodes from command
        vSeeds.push_back(CDNSSeedData("23.95.8.132", "23.95.8.132"));
		vSeeds.push_back(CDNSSeedData("192.3.61.144","192.3.61.144"));
		vSeeds.push_back(CDNSSeedData("107.172.201.12","107.172.201.12"));
		vSeeds.push_back(CDNSSeedData("107.174.250.12","107.174.250.12"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // StableCoin: 1 day
        nTargetSpacing = 1 * 60;  // StableCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
      ...
      genesis.nNonce = 886834; 
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.stablecoin.io", "testnet.stablecoin.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.stablecoin.io", "testnet1.stablecoin.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.stablecoin.io", "testnet2.stablecoin.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // StableCoin: 1 day
        nTargetSpacing = 1 * 60;        // StableCoin: 1 minutes

...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(STABL);
    unitlist.append(mSTABL);
    unitlist.append(uSTABL);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case STABL:
        return QString("stablecoin");
    case mSTABL:
        return QString("mstablecoin");
    case uSTABL:
        return QString::fromUtf8("ustablecoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case STABL:
            return QString("STABL");
        case mSTABL:
            return QString("mSTABL");
        case uSTABL:
            return QString::fromUtf8("μSTABL");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case STABL:
            return QString("tSTABL");
        case mSTABL:
            return QString("mtSTABL");
        case uSTABL:
            return QString::fromUtf8("μtSTABL");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case STABL:
            return QString("STABL");
        case mSTABL:
            return QString("Milli-STABL (1 / 1" THIN_SP_UTF8 "000)");
        case uSTABL:
            return QString("Micro-STABL (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case STABL:
            return QString("TestSTABLs");
        case mSTABL:
            return QString("Milli-TestSTABL (1 / 1" THIN_SP_UTF8 "000)");
        case uSTABL:
            return QString("Micro-TestSTABL (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
